#' Theme for figures in word processing documents.
#' 
#' \code{theme_wordfig} applies custom theme to ggplot objects.
#' 
...
theme_wordfig <- function(...) {
  theme_minimal() +
    theme(
      text = element_text(family = "Helvetica", color = "#22211d", size=12),
